          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="card card-primary">
                        <div class="card-header">
                          <h3 class="card-title">Forms for adding Supervisor</h3>
                        </div>
            ...
            if (isset($_POST['submit'])) {
              ...
              $status = $_POST['status'];
               ...
               $sql = "SELECT * FROM supervisor WHERE fullname = '$superivsor_name' and phone_number = '$phone_number' and `market_id` = '$market_id'";
              ...
              if (mysqli_query($con, "INSERT INTO `supervisor`( `fullname`, `phone_number`, `market_id`, `status`)  VALUES 
              ('$superivsor_name', '$phone_number', '$market_id', '$status')")) {
