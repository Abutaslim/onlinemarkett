...
<div class="col-md-12">
    ...
    <div class="card card-primary">
        ...
        $status = '';
        $hidden_id = 0;
        $query = mysqli_query($con, "SELECT * FROM `log_book`  WHERE id = '$id' ");
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form action="logbook_edit.php" method="POST">
            <div class="card-body">
...
if ( mysqli_query($con, "UPDATE `log_book`SET `forms_sold` = '$forms_sold', `enumerator_id`= '$enumerator_id', `supervisor_id`= '$supervisor_id', `date` = '$date', `status`= '$status' WHERE id = '$hidden_id
    '"))
{

$_SESSION['success'] = 'Record Updated Successfully';
echo "<meta http-equiv='refresh' content = '0; url = logbook_edit.php'/>";
