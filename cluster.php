...
//The commented codes below is use for validation
// if(empty($cluster_name)){
//   echo "The Cluster name must be entered";
// }
...
if (mysqli_query($con, "INSERT INTO `cluster`(`cluster_name`, `status`) VALUES ('$cluster_name', '$status')")) {
