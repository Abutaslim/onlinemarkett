...
<head>
  ...
  <title>Bufties~Global | Password Reset Form</title>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Form for Password Reset</h3>
              </div>
...
include 'connection.php'; 
  ...
  $username=$_POST["username"];
   ...
   $password='bufties1000';

  $sql="select `ukey`,`email` from `users`  where `email`= '$username'";
  
  $id = 0;
  $result = mysqli_query($con,$sql);
  $nrows = mysqli_num_rows($result);
  if ($nrows == 0)  {
    $_SESSION['danger'] ='Account dosn`nt exist';
