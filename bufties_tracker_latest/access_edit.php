...
<head>
  ...
  <title>Bufties ~ Tracker | Access Edit Form</title>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            < <!-- Content Wrapper. Contains page content -->
              <div class="content-wrapper">
                ...
                <section class="content-header">
                  <div class="container-fluid">
                    <div class="row mb-2">
                      <div class="col-sm-6">
                        <h1>Access Edit Form</h1>
                      </div>
                      <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                          <li class="breadcrumb-item"><a href="#">Home</a></li>
                          <li class="breadcrumb-item active">Access Edit Form</li>
                        </ol>
                      </div>
                    </div>
                  </div><!-- /.container-fluid -->
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                          <div class="card-header">
                            <h3 class="card-title">Form for Editing Access</h3>
                          </div>
                          <!-- /.card-header -->
                          <!-- form start -->
                          ...
                          $status = '';
                          $hidden_id = 0;
                          $query = mysqli_query($con, "SELECT * FROM `access`  WHERE ukey = '$id' ");
                          ...
                          ?>
                          <form action="access_edit.php" method="POST">
                            <div class="card-body">
                              ...
                              <div class="form-group">
                                ...
                                <select id="urlpage" name="urlpage" class="form-control">
                                  <option value="">Select Url Pages</option>
                                  <?php
                                  $sql = "SELECT * FROM `previllages`";
                                  $query = mysqli_query($con, $sql);
                                  while ($rows = mysqli_fetch_array($query)) {
              ...
              if (isset($_POST['submit'])) {
                ...
                //echo($id);
                if (mysqli_query($con, "UPDATE `access` SET `roleukey`='$role', `previllageukey`='$urlpage',`status`='$status' WHERE `ukey` = '$hidden_id'")) {
                  ...
                  echo "<meta http-equiv='refresh' content = '0; url = access_edit.php'/>";
              ...
              <script>
                ...
                document.getElementById('role').selectedIndex = '<?php echo $role; ?>';
