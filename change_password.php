...
<head>
  ...
  <title>Bufties ~ Tracker | Change Password</title>
  ...
  <div class="content-wrapper">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Form that allows you to Change Password</h3>
              </div>
    ...
    <div class="card-body register-card-body">
      ...
      <form action="change_password.php" method="POST">
        ...
        <div class="input-group mb-3">
          <input type="password" id="confirm_password" class="form-control" name="confirm_password" placeholder="Retype password">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
...
include 'connection.php';
  ...
  $sql="SELECT `ukey`,`email`,`password` from `users` WHERE `email`= '$username'";
  ...
  if ($nrows == 0){
    echo '<div class="login">This Account does`nt exist or contact System Administrator</div>';
  } else {
      // echo $nrows;
      $hash_password = '';
      ...
      if ($old_password == $hash_password)
      {
        ...
        //$hash_pass = password_hash($password, PASSWORD_DEFAULT);
          $sql = "update users set password = '$password' where ukey = '$id'";

          if (mysqli_query($con, $sql)) {
        
            $_SESSION['success'] ='Password Updated Successfuly';
            echo "<meta http-equiv='refresh' content = '0; url = change_password.php'/>";
          }
      }
      else
          {
        $_SESSION['danger'] ='Invalid Old Password';
      echo "<meta http-equiv='refresh' content = '0; url = change_password.php'/>";
