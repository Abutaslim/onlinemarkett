        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                      ...
                      <div class="card card-primary">
                        ...
                        <form action="roles.php" method="POST">
                          <div class="card-body">
                                ...
                                <div class="col-sm-4">
                                <div class="form-group">
                                  <label for="status">Roles Status</label>
                                  <select id="status" name="status" class="form-control">
                                    <option value="">Select Roles Status</option>
                          ...
                          <div class="card-footer">
                            <button type="submit" name="submit" id="submit" class="btn btn-primary">Submit</button>
                             <a href="roles_list.php" class="btn btn-primary float-right">View Roles</a>
                          </div>
                        </form>
                      </div>
                      <!-- /.card -->
            ...
            if (isset($_POST['submit'])) {
              ...
              if (mysqli_query($con, "INSERT INTO `roles`( `role_name`, `status`) VALUES ('$role_name', '$status')")) {

                $_SESSION['success'] = 'Record Inserted Successfully';
                echo "<meta http-equiv='refresh' content = '0; url = roles.php'/>";
