        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <div class="col-md-12">
                      ...
                      echo  $ukey = @$_GET['ukey'];
                        ...
                        while (@$row = mysqli_fetch_array($result)){
                            echo $role_ukey = $row[1];
                            echo $name = $row[2];
                            echo $phone_num = $row[3];
                            echo $email = $row[4];
                            echo $username = $row[5];
                            echo $password = $row[6];
                            echo $status = $row[11];
                            echo $hidden_ukey = $row[0];
                        }
                        ?>
                        <!-- /.card-header -->
                        <!-- form start -->
            ...
            if (isset($_POST['submit'])) {
              ...
              if (mysqli_query($con, "UPDATE `users` SET `role_ukey` = '$role_ukey', `name` = '$name', `phone_num` = '$phone_num', `email` = '$email', `username` = '$username', `password` = '$password'  WHERE `ukey` = '$ukey'")) {
