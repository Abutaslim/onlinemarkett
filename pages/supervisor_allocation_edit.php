...
<head>
  ...
  <title>Bufties ~ Global | Users Edit</title>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="card card-primary">
                        <div class="card-header">
                          <h3 class="card-title">Edit of Users</h3>
                        </div>
                      ...
                      echo $id = @$_GET['id'];
                        ...
                        $result = mysqli_query($con, "SELECT * FROM supervisor_allocation WHERE id = $id");
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form id="supervisor_allocation_edit" action="supervisor_allocation_edit.php" method="POST">
                          <div class="card-body">
                          ...
                          <div class="card-footer">
                            ...
                            <a href="supervisor_allocation_list.php" class="btn btn-primary float-right">View Supervisor Allocation</a>
                          </div>
                        </form>
                      </div>
                      <!-- /.card -->
            ...
            if (isset($_POST['submit'])) {
              ...
              $status = $_POST['status'];
              $supervisor_allocation_id = $_POST['hidden_id'];

              $sql = "SELECT * FROM supervisor_allocation WHERE `cluster_id` = '$cluster_id' AND supervisor_id = '$supervisor_id' AND enumerator_id = '$enumerator_id' AND  `status` = '$status' ";
              $rows = mysqli_num_rows(mysqli_query($con, $sql));
               if ($rows == 1) {
                   $_SESSION['danger'] = 'Record already Exist';
                   echo "<meta http-equiv='refresh' content = '0; url = supervisor_allocation_edit.php'/>";

               } else {
              
              if (mysqli_query($con, "UPDATE `supervisor_allocation` SET `cluster_id` = '$cluster_id', `supervisor_id` = '$supervisor_id', `enumerator_id` = '$enumerator_id', `status` = '$status'  WHERE `id` = '$supervisor_allocation_id'")) {
...
<script type="text/javascript">
  document.getElementById('cluster_id').selectedIndex = '<?php echo $cluster_id; ?>';
