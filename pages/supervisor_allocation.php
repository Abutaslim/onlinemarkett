            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="card card-primary">
                                                ...
                                                <!-- /.card-header -->
                                                <!-- form start -->
                                                <form action="supervisor_allocation.php" method="POST">
                                                    <div class="card-body">
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $sql = "SELECT * FROM supervisor_allocation WHERE enumerator_id = '$enumerator_id' and supervisor_id = '$supervisor_id' and cluster_id = '$cluster_id'";
                           $rows = mysqli_num_rows(mysqli_query($con, $sql));
                            if ($rows == 1) {
                                $_SESSION['danger'] = 'Record exist';
                                echo "<meta http-equiv='refresh' content = '0; url = supervisor_allocation.php'/>";

                            } else {
                                
                            
                            if (
                                mysqli_query($con, "INSERT INTO `supervisor_allocation`(`cluster_id`, `supervisor_id`, `enumerator_id`, `status`)   VALUES 
                                ('$cluster_id','$supervisor_id','$enumerator_id', '$status')")
                            ) {
