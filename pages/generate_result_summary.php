...
<head>
  ...
  <title>BUK~AEE | Generate Result Summary</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Result Summary Form</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Result Summary Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Form for generating Result Summary</h3>
              </div>
  ...
  <!-- <div class="form-group">
   ...
   -->
                ...
                <div class="card-footer">
                  <button type="submit" name="result_summary" class="btn btn-primary">Generate Result Summary</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
...
<?php include 'layouts/footer.php'; 
  ...
  echo "<meta http-equiv='refresh' content = '0; url = result_summary.php'/>";  
} else {

      $_SESSION['alert'] = 'Sorry! The record does not exist';
      echo "<meta http-equiv='refresh' content = '0; url = generate_result_summary.php'/>";
