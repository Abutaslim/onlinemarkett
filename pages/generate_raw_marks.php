...
<head>
  ...
  <title>BUK~AEE | Generate Raw Marks</title>
...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Raw Marks Form</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Raw Marks Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Form for generating Raw Marks</h3>
              </div>
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="generate_raw_marks.php" method="POST">
                 <form action="generate_result_summary.php" method="POST">
                <div class="card-body">
  ...
  <!--
  <div class="form-group">
    <label for="lc_name">Name of Level Coordinator:</label>
      <input type="text" placeholder="Enter Name of Level Coordinator" name="lc_name" class="form-control">
    </div>
  <div class="form-group">
    <label for="eo_name">Name of Exam Officer:</label>
      <input type="text" placeholder="Enter Name of Exam Officer" name="exam_officer" class="form-control">
    </div>
  <div class="form-group">
    <label for="hod_name">Name of Head of Department:</label>
      <input type="text" placeholder="Enter Name of Head of Department" name="hod_name" class="form-control">
    </div> -->
  <!-- <div class="form-group">
    <label for="dean_name">Name of Dean (Chief Exerminer):</label>
      <input type="text" placeholder="Enter Name of Dean (Chief Exerminer)" name="dean_name" class="form-control">
    </div>
 -->
                </div>
                <!-- /.card-body -->
                ...
                <div class="card-footer">
                  <button type="submit" name="result_summary" class="btn btn-primary">Generate Raw Marks</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
...
<?php include 'layouts/footer.php'; 
   if (isset($_POST['result_summary'])) {
    ...
    if ((mysqli_num_rows($result1))>0) {
     ...
     //    $_SESSION['lc_name'] = $_POST['lc_name'] ;
     //    $_SESSION['exam_officer'] = $_POST['exam_officer'];
     //    $_SESSION['dean_name'] = $_POST['dean_name'];
        
     }   
    $i++;

  } 
  echo "<meta http-equiv='refresh' content = '0; url = raw_marks.php'/>";  } else {

      $_SESSION['alert'] = 'Sorry! The record does not exist';
      echo "<meta http-equiv='refresh' content = '0; url = generate_raw_marks.php'/>";
