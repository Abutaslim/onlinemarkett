...
<head>
  ...
  <title>BUK~AEE | Course Edit Form</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Course Edit Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Form for Course Editing </h3>
              </div>
              ...
              <form action="course_edit.php" method="POST">
                <?php include 'connection.php';
                      ...
                      $level_id = 0;
                      $semester_id = 0;
                      $stm = $pdo->query("SELECT * FROM `course`  WHERE id = '$id'");
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                   ...
                   <input type="text" name="credit_unit" class="form-control" id="credit_unit" placeholder="Enter Credit Unit">
                  </div>
                  ...
                  <div class="form-group">
                    <label  for="credit_unit">Status</label>
                   <input type="text" class="form-control" name="status"  id="status" placeholder="Enter Credit Unit">
                  </div>
...
<script type="text/javascript">
  document.getElementById('course_code').value = '<?php echo $course_code; ?>';
  document.getElementById('course_title').value = '<?php echo $course_title; ?>';
  document.getElementById('credit_unit').value = '<?php echo $credit_unit; ?>';
...
<?php include 'layouts/footer.php'; 
  ...
  if (isset($_POST['submit'])) {
    ...
    //echo($id);
    $query = "";
          if($pdo->exec("UPDATE `course` SET `course_code`='$course_code', `credit_unit`='$credit_unit',`course_name`='$course_title',`level_id`='$level_id',`semester_id`='$semester_id',`status` = '$status' WHERE `id` = '$hidden_id'") === false) 
    
     { 
      $_SESSION['danger'] ='Record Not Updated, Please try again, if it persist contact system Administrator';
      echo "<meta http-equiv='refresh' content = '0; url = courses_edit.php'/>";

      
     } else {
      $_SESSION['success'] ='Record Updated Successfully';
      echo "<meta http-equiv='refresh' content = '0; url = courses_list.php'/>";
