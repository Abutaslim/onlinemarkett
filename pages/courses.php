...
<head>
  ...
  <title>BUK~AEE | Course Form</title>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Form for adding course</h3>
              ...
              <form action = 'courses.php' method = 'POST'>
                <div class="card-body">
                  ...
                  <div class="form-group">
                   ...
                   <input type="Number" class="form-control" id="credit_unit" name= 'credit_unit' required placeholder="Enter Credit Unit">
                  </div>
...
if (isset($_POST['submit'])) {
    ...
    if($pdo->exec("INSERT INTO `course` (course_code, course_name, credit_unit, level_id, semester_id) VALUES ('$course_code', '$course_title', '$credit_unit', '$level_id', '$semester_id')") === false) 
