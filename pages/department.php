...
<head>
  ...
  <title>BUK~AEE | Department Form</title>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Form adding Department</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form>
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="department_name" placeholder="Enter Department Name">
                  </div>
                  <div class="form-group">
