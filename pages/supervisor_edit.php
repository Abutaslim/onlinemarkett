        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            ?>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="supervisor_edit.php" id="supervisoredit" method="POST">
                          <div class="card-body">
            ...
            if (isset($_POST['submit'])) {
              ...
              $status = $_POST['status'];
              $supervisor_id = $_POST['hidden_id'];
             
              if (mysqli_query($con, "UPDATE `supervisor` SET `fullname` = '$supervisor_name', `phone_number` = '$phone_number', `status` = '$status' WHERE `id` = '$supervisor_id'"))
...
<script type="text/javascript">
  ...
  document.getElementById("supervisor_edit").addEventListener("submit", function(event) {
            var nameField = document.getElementById("supervisor_name");
...
// To validate Phone Number field
        const supervisoredit = document.getElementById("supervisoredit");
        const phone_numberInput = document.getElementById("phone_number");
        const phoneError = document.getElementById("phoneError");

        supervisoredit.addEventListener("submit", function (event) {
