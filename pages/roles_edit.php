...
<head>
  ...
  <title>BUK~AEE | Role Edit Form</title>
            ...
            < <!-- Content Wrapper. Contains page content -->
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                          <div class="card-header">
                            <h3 class="card-title">Form for Editing faculty</h3>
                          </div>
                          <!-- /.card-header -->
                          <!-- form start -->
                          <?php include 'connection.php';
                           echo
                            ...
                            $status = '';
                            $hidden_id = 0;
                            $query = mysqli_query($con, "SELECT * FROM `roles`  WHERE ukey = '$id' ");
                          ...
                          <form action="roles_edit.php" method="POST">
                            ...
                            <div class="card-body">
                              <div class="form-group">
                                ...
                                <input type="text" value="<?php echo ($role_name) ?>" class="form-control"
              ...
              <?php include 'layouts/footer.php'; 
                 if (isset($_POST['submit'])) {
                  ...
                  //echo($id);
                       if(mysqli_query($con, "UPDATE `roles` SET `role_name`='$role_name',`status`='$status' WHERE `ukey` = '$hidden_id'")) 
                  
                   {
                    $_SESSION['success'] ='Record Updated Successfully';
                    echo "<meta http-equiv='refresh' content = '0; url = roles_list.php'/>";                    
                    
                   } else {

                    $_SESSION['danger'] ='Record Not Updated, Please try again, if it persist contact system Administrator';
                    echo "<meta http-equiv='refresh' content = '0; url = roles_edit.php'/>";
              ...
              <script>
                ...
                document.getElementById('role_name').value = '<?php echo $role_name; ?>';
              </script> 