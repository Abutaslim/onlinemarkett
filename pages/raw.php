...
//      $credits = "";
  ...
  $courseData = []; $regno = 0; $headings = ''; $row_final = 0;
...
$list_courses = [];
  ...
  while ($row = mysqli_fetch_array($result)) {
    ...
    // $subjects = "S/N,REGNO,NAME,COURSES,TCR,TCE,WGP,GPA,TCUR,TCUE,TWGP,CGPA,REMARKS";
        // }
...
// Formatting worksheet
    ...
    $style_num_row = $num_student+7;
       $sheet->getStyle("A7:".$col.'7')->applyFromArray($styleArray_tableHeader);
